...
export default function FacultyDashboard({
    ...
    const statItems = [
        ...
        },
        {
            ...
            icon: <TeamOutlined style={{ color: accentPrimary }} />,
        },
        {
            key: 'approved',
            label: 'Approved',
    ...
    const remarkTemplateOptions = getReviewRemarkTemplates('under_review_faculty').map(
                    ...
                    <Row gutter={[24, 24]} align="middle">
                        <Col xs={24} lg={16}>
                            <Space direction="vertical" size={10}>
                                ...
                                >
                                    Move pending papers through faculty review, handle rejections,
                                    and forward qualified work to HEI.
                                </Typography.Paragraph>
                            </Space>
                        </Col>
                        <Col xs={24} lg={8}>
                ...
                >
                    {forReview.length === 0 ? (
                        <Alert
                            type="success"
                            showIcon
                            message="No submissions waiting for Faculty review."
                        />
                    ) : (
                        <Table
                            rowKey="id"
