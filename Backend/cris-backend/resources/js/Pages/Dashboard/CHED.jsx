...
export default function CHEDDashboard({
    ...
    const remarkTemplateOptions = getReviewRemarkTemplates('under_review_ched').map((template) => ({
        value: template,
        label: template,
    }));
    ...
    const pendingColumns = [
        ...
        },
        {
            ...
            render: (_, row) => (
                <Space>
                    <Popconfirm
                        title="Final approve this submission?"
                        okText="Approve"
                        onConfirm={() =>
                    ...
                    <Row gutter={[24, 24]} align="middle">
                        <Col xs={24} lg={16}>
                            <Space direction="vertical" size={10}>
                                ...
                                >
                                    Prioritize pending studies, review institutional submissions,
                                    and move decisions through the queue faster.
                                </Typography.Paragraph>
                            </Space>
                        </Col>
                        <Col xs={24} lg={8}>
                ...
                >
                    {forReview.length === 0 ? (
                        <Alert
                            type="success"
                            showIcon
                            message="No papers pending review. The current queue is clear."
                        />
                    ) : (
                        <Table
                            rowKey="id"
                            ...
                            locale={{
                                emptyText: (
                                    <EmptyState
                                        ...
                                        description="No papers are currently waiting for CHED final review."
                                    />
                                ),
                            }}
                        />
