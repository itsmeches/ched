                        ...
                        {monthlyTrends.length > 0 ? (
                            <ResponsiveContainer width="100%" height={300}>
                                <AreaChart data={monthlyTrends}>
                                    ...
                                    <Area type="monotone" dataKey="submissions" stroke={accentPrimary} strokeWidth={2} fill="url(#heiSubmissions)" name="Submissions" />
                                    <Area type="monotone" dataKey="approved" stroke="#16a34a" strokeWidth={2} fill="url(#heiApproved)" name="Approved" />
                                </AreaChart>
                            </ResponsiveContainer>
                        ) : (
