...
export default function FacultyCharts({ stats = {}, stageCounts = {}, monthlyTrends = [], studentBreakdown = [] }) {
    ...
    return (
        <div className="space-y-4">
            <Row gutter={[16, 16]}>
                <Col xs={24} xl={16}>
                    <Card className="admin-dashboard-shell" bordered={false} title="Student Submission Trend">
            ...
            <Row gutter={[16, 16]}>
                ...
                <Col xs={24} xl={12}>
                    <Card className="admin-dashboard-shell" bordered={false} title="Top Student Submissions">
