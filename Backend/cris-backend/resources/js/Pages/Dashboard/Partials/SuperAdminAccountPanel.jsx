...
export default function SuperAdminAccountPanel({
    data,
    setData,
    postSubmit,
    processing,
                ...
                <Card
                    ...
                    extra={
                        <Tag
                            style={{
                                color: accentPrimary,
                                backgroundColor: dark ? 'rgba(147,197,253,0.15)' : '#e6f2ff',
                    ...
                    className="admin-dashboard-shell dashboard-table-card super-admin-account-panel"
                    bordered={false}
                >
                    <Typography.Paragraph type="secondary" style={{ maxWidth: 860 }}>
                        Create HEI, Faculty, Student, CHED, or Super Admin users here. New accounts
                        are available immediately after save.
                    ...
                    <Form layout="vertical" onSubmitCapture={postSubmit}>
                            ...
                            <Col xs={24} md={12}>
                                ...
                                >
                                    <Select
                                        ...
                                        placeholder={
                                            ['hei', 'faculty', 'student'].includes(data.role)
                        ...
                        <Space direction="vertical" size={16} style={{ width: '100%' }}>
                            <Alert
                                type="info"
                                showIcon
                                message="HEI, Faculty, and Student accounts must be linked to an institution. CHED and Super Admin accounts remain unassigned by design."
                            />
                            <Space wrap style={{ justifyContent: 'space-between', width: '100%' }}>
                                <Button
                                    size="large"
                                    icon={<PlusOutlined />}
                                    onClick={() => router.visit(route('admin.institutions.create'))}
                                >
