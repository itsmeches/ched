                                ...
                                <Col xs={24} md={8}>
                                    <Select
                                        ...
                                        options={[
                                            ...
                                            {
                                                value: 'under_review_faculty',
                                                label: 'Under Review (Faculty)',
                                            },
                                            {
                                                value: 'under_review_hei',
                                                label: 'Under Review (HEI)',
                                            },
                                            {
                                                value: 'under_review_ched',
                                                label: 'Under Review (CHED)',
                                            },
                        ...
                        locale={{
                            emptyText: (
                                <EmptyState
                                    ...
                                    description="Try broadening your status or keyword filters."
                                />
                            ),
                        }}
                    />
